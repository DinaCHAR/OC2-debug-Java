 ...
 * Elle utilise un ISymptomReader pour lire les symptômes à partir d'un fichier, un AnalyticsCounter pour trier et compter les symptômes, et un ISymptomWriter pour écrire les résultats dans un fichier de sortie,
